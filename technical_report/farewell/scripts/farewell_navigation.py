...
class NavToPoint:
    def __init__(self):
        ...
        rospy.Subscriber('/farewell_nav',Int32,self.navCallback)
        self.pub = rospy.Publisher('/farewell_feature', Int32, queue_size=10)
        self.pub1 = rospy.Publisher('/farewell_reset', Int32, queue_size=10)
